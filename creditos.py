...
def reproducir_video(video_path, audio_path, on_stop_callback):
    ...
    while cap.isOpened():
        ...
        frame = pygame.transform.scale(frame, (constantes.anchoVentana, constantes.altoVentana))
...
def instrucciones():
    reproducir_video("assets/animations/credits.mp4", "assets/animations/credits.mp3", on_stop_callback=dificultad) 
